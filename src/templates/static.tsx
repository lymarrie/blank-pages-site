    ...
    <>
      <main className="min-h-screen bg-gray-50 border shadow-md m-20 rounded-md">
        <section className="flex flex-col items-center justify-center py-20 space-y-10">
          <h1 className="text-5xl font-semibold">Home Page (Branch)</h1>
          <img
            className="rounded-md shadow-md"
            width="1000px"
            height="300px"
            src="https://www.builtinnyc.com/sites/www.builtinnyc.com/files/12647406_1321015814582617_5253019365679367489_n_0.jpg"
          />
        </section>
      </main>
    </>
